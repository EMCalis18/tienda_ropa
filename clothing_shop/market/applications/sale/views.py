...
from .fuctions import procesar_venta
...
class CarShopUpdateLessView(VentasPermisoMixin, View):
...
class CarShopUpdateMoreView(VentasPermisoMixin, View):
...
class CarShopDeleteView(VentasPermisoMixin, DeleteView):
    model = CarShop
    success_url = reverse_lazy('sale_app:sale-index')
